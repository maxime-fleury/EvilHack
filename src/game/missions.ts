...
export const MISSION_TEMPLATES: MissionTemplate[] = [
  ...
  {
    id: "wifi_elite",
    title: { en: "The Elite Wi-Fi", fr: "Le Wi-Fi d'Élite" },
    giver: { en: "The barista (in tears)", fr: "La barista (en larmes)" },
    repReq: 1,
    blurb: {
      en: "The café's Wi-Fi is 'password123' — again. A rival café keeps stealing their customers by having a fancier network name. Change the router's SSID to 'LATTE_ART_MASTERS' and its password to something a golden retriever could guess. She says she'll give you free coffee. She lies.",
      fr: "Le Wi-Fi du café est « password123 » — encore. Un café rival vole leurs clients avec un nom de réseau plus classe. Changez le SSID du routeur en « LATTE_ART_MASTERS » et son mot de passe en quelque chose qu'un golden retriever pourrait deviner. Elle dit qu'elle vous offrira un café. Elle ment.",
    },
    target: "Cafe Wi-Fi",
    difficulty: 1,
    minutes: 25,
    ...
    deadlineDays: 2,
    success: {
      en: "The SSID is now 'LATTE_ART_MASTERS' and the password is 'coffee'. The rival café's customers flood back. The barista hands you a cup with a latte-art heart. It says 'MISTAKE' in foam. She wasn't lying about the coffee. Only about the love.",
      fr: "Le SSID est maintenant « LATTE_ART_MASTERS » et le mot de passe « coffee ». Les clients du café rival reviennent en masse. La barista vous tend une tasse avec un cœur en latte-art. Il écrit « ERREUR » en mousse. Elle n'a pas menti pour le café. Seulement pour l'amour.",
    },
    fail: {
      en: "You never touched the router. The rival café installs a fountain. The barista cries into the espresso machine.",
      fr: "Vous n'avez jamais touché au routeur. Le café rival installe une fontaine. La barista pleure dans la machine à espresso.",
    },
  },
  {
    id: "hoa_espionage",
    title: { en: "The HOA Intelligence Bureau", fr: "Le Bureau du Renseignement de la Copropriété" },
    giver: { en: "The HOA president (whispering)", fr: "La présidente de la copropriété (en chuchotant)" },
    repReq: 2,
    blurb: {
      en: "The HOA president suspects the neighbors of 'illegal lawn activities' (a gnome was moved 3 inches). She wants you to pull the router logs and find out who's been downloading 'suspicious amounts of gardening videos'. It's a trap. It's always a trap with HOAs. But the pay is real.",
      fr: "La présidente de la copropriété soupçonne les voisins d'« activités de pelouse illégales » (un nain a été déplacé de 7 cm). Elle veut que vous récupériez les journaux du routeur pour trouver qui télécharge des « quantités suspectes de vidéos de jardinage ». C'est un piège. C'est toujours un piège avec les copropriétés. Mais le salaire est réel.",
    },
    target: "HOA Router",
    difficulty: 1,
    minutes: 30,
    ...
    style: 3,
    heat: 2,
    needsHack: "HOA Router",
    twist: {
      en: "The logs show the HOA president herself downloading 'How to Frame My Neighbors 101' at 3 AM. She's been setting up the gnome incident the whole time. The Board is a circus. The gnome is innocent.",
      fr: "Les journaux montrent la présidente de la copropriété en train de télécharger « Comment piéger mes voisins 101 » à 3 h du matin. Elle a monté l'incident du nain depuis le début. Le conseil est un cirque. Le nain est innocent.",
    },
    deliverOptions: [
      {
        key: "a",
        label: { en: "Expose the president", fr: "Dénoncer la présidente" },
        result: {
          en: "The Board convenes an emergency meeting. The president is voted out, the gnome is reinstated with full honors, and a plaque is installed: 'The Gnome Is Innocent.' You are now a hero of the HOA — which means they will never stop asking you for help. Ever.",
          fr: "Le conseil convoque une réunion d'urgence. La présidente est destituée, le nain est réinstallé avec tous les honneurs, et une plaque est posée : « Le nain est innocent. » Vous êtes maintenant un héros de la copropriété — ce qui signifie qu'ils ne cesseront jamais de vous demander de l'aide. Jamais.",
        },
        pay: 150,
        rep: 3,
        style: 5,
      ...
      {
        key: "b",
        label: { en: "Blackmail the president", fr: "Faire chanter la présidente" },
        result: {
          en: "You sit on the evidence. The president quietly agrees to 'forget' several of your parking violations. The gnome remains in its new position — a silent monument to your corruption. You feel a little sick. Then you remember the parking fines.",
          fr: "Vous gardez la preuve. La présidente accepte discrètement d'« oublier » plusieurs de vos infractions de stationnement. Le nain reste dans sa nouvelle position — un monument silencieux à votre corruption. Vous vous sentez un peu mal. Puis vous vous souvenez des amendes de stationnement.",
        },
        pay: 300,
        heat: 4,
        hatShift: 5,
    ...
    success: {
      en: "The logs are handed over. The HOA's secret is safe with you — for now.",
      fr: "Les journaux sont remis. Le secret de la copropriété est en sécurité avec vous — pour l'instant.",
    },
    fail: {
      en: "You were too slow. The president 'fixes' the router with a hammer. The gnome incident goes unresolved, which is, historically, the only way gnome incidents ever end.",
      fr: "Vous avez été trop lent. La présidente « répare » le routeur au marteau. L'incident du nain reste non résolu, ce qui est, historiquement, la seule façon dont les incidents de nains se terminent.",
    },
  },
  {
    id: "chen_heirloom",
    title: { en: "The Chen Heirloom", fr: "L'Héritage Chen" },
    giver: { en: "Mrs. Chen (sternly)", fr: "Mme Chen (sévèrement)" },
    repReq: 4,
    blurb: {
      en: "Mrs. Chen's family has a tradition: every Lunar New Year, the recipe for 'Auntie Chen's World-Famous Dumplings' is updated in the family server and locked. This year, a rival aunt edited it to add 'a pinch of betrayal'. Restore the original recipe and delete the sabotage. Do NOT look at the other files. Look at the other files.",
      fr: "La famille Chen a une tradition : chaque Nouvel An lunaire, la recette des « Dumplings de renommée mondiale de Tante Chen » est mise à jour dans le serveur familial et verrouillée. Cette année, une tante rivale l'a modifiée pour ajouter « une pincée de trahison ». Restaurez la recette originale et supprimez le sabotage. Ne REGARDEZ PAS les autres fichiers. Regardez les autres fichiers.",
    },
    target: "Chen Realty LLC",
    difficulty: 2,
    minutes: 40,
    payout: 200,
    rep: 3,
    style: 4,
    heat: 3,
    needsHack: "Chen Realty LLC",
    twist: {
      en: "The sabotage wasn't the rival aunt. It was Mrs. Chen's own son, who added 'a pinch of betrayal' to the recipe as a cry for help — he wants to open a fusion dumpling-taco truck and his mother said no. The dumplings are a battlefield. The taco truck is the peace treaty.",
      fr: "Le sabotage ne venait pas de la tante rivale. C'était le fils de Mme Chen, qui a ajouté « une pincée de trahison » à la recette comme appel à l'aide — il veut ouvrir un food-truck de fusion dumplings-tacos et sa mère a dit non. Les dumplings sont un champ de bataille. Le taco truck est le traité de paix.",
    },
    deliverOptions: [
      {
        key: "a",
        label: { en: "Restore the recipe, tell Mrs. Chen about her son", fr: "Restaurer la recette, parler du fils à Mme Chen" },
        result: {
          en: "Mrs. Chen reads her son's note. She is silent for a long time. Then: 'The taco truck… he would need good ventilation. And a permit. I know a guy.' The dumplings are restored. The family is saved. You are invited to the grand opening. The fusion truck is called 'Wonton Voyage'. It slaps.",
          fr: "Mme Chen lit la note de son fils. Elle se tait longtemps. Puis : « Le taco truck… il aurait besoin d'une bonne ventilation. Et d'un permis. Je connais quelqu'un. » Les dumplings sont restaurés. La famille est sauvée. Vous êtes invité à la grande ouverture. Le truck s'appelle « Wonton Voyage ». C'est une tuerie.",
        },
        pay: 200,
        rep: 4,
        style: 6,
      ...
      {
        key: "b",
        label: { en: "Restore the recipe, keep the secret", fr: "Restaurer la recette, garder le secret" },
        result: {
          en: "You restore the dumplings and delete the sabotage. The son's note goes into your pocket, where it belongs. He finds you later: 'I know what you did. Thanks for not telling mom.' He leaves a coupon for the taco truck. It doesn't exist yet. But it will.",
          fr: "Vous restaurez les dumplings et supprimez le sabotage. La note du fils va dans votre poche, où elle doit être. Il vous retrouve plus tard : « Je sais ce que tu as fait. Merci de ne rien avoir dit à maman. » Il laisse un coupon pour le taco truck. Il n'existe pas encore. Mais il existera.",
        },
        pay: 250,
        style: 5,
        flag: { key: "chenSonAlly", value: true },
      },
    ],
    success: {
      en: "The dumplings are safe. The family drama simmers on, as it always has.",
      fr: "Les dumplings sont sauvés. Le drame familial mijote, comme toujours.",
    },
    fail: {
      en: "You hesitated too long. The sabotage ferments. The dumplings are now 'spicy'. The family blames the cousin. The cousin blames the weather. The weather has alibis.",
      fr: "Vous avez hésité trop longtemps. Le sabotage fermente. Les dumplings sont maintenant « épicés ». La famille accuse le cousin. Le cousin accuse la météo. La météo a des alibis.",
    },
  },
  {
    id: "crypto_atm_hotdog",
    title: { en: "The Hot Dog Heist", fr: "Le Vol du Hot Dog" },
    giver: { en: "A street vendor (seriously)", fr: "Un vendeur ambulant (sérieusement)" },
    repReq: 6,
    blurb: {
      en: "The street vendor's business is dying because the crypto ATM next door draws all the 'financially unstable' crowd who buy his hot dogs then try to pay in 'future money'. He wants you to 'recalibrate' the ATM so it dispenses the occasional free hot dog. He calls it 'charity with extra steps'.",
      fr: "Le commerce du vendeur ambulant meurt parce que le DAB crypto d'à côté attire toute la foule « financièrement instable » qui achète ses hot dogs puis essaie de payer en « argent du futur ». Il veut que vous « recalibriez » le DAB pour qu'il distribue un hot dog gratuit de temps en temps. Il appelle ça « la charité avec des étapes en plus ».",
    },
    target: "The Crypto ATM",
    difficulty: 4,
    minutes: 80,
    payout: 400,
    rep: 5,
    style: 7,
    heat: 6,
    needsHack: "The Crypto ATM",
    needsExploit: "zero",
    twist: {
      en: "The ATM doesn't just convert cash to crypto. It also logs every transaction to a 'friend' in a truck parked nearby. You've found the money-laundering operation Vlad's been running — and now you're inside it. The hot dog vendor? He's part of it. He's the courier. His mustard has been a front the whole time.",
      fr: "Le DAB ne convertit pas seulement le cash en crypto. Il envoie aussi chaque transaction à un « ami » dans une camionnette garée à côté. Vous venez de trouver l'opération de blanchiment de Vlad — et vous êtes maintenant dedans. Le vendeur de hot dogs ? Il en fait partie. C'est le coursier. Sa moutarde était une couverture depuis le début.",
    },
    deliverOptions: [
      {
        key: "a",
        label: { en: "Turn the evidence over to the cops (via the tip line)", fr: "Remettre les preuves aux flics (via la ligne de dénonciation)" },
        result: {
          en: "You anon-drop the logs. The ATM disappears overnight. The vendor disappears too — but he leaves you a single hot dog with a note: 'The mustard was always real. Good luck.' The street is quiet. The fries are unclaimed. You win this round, whatever winning means.",
          fr: "Vous balancez les journaux en anonyme. Le DAB disparaît du jour au lendemain. Le vendeur disparaît aussi — mais il vous laisse un hot dog avec une note : « La moutarde a toujours été vraie. Bonne chance. » La rue est calme. Les frites sont sans propriétaire. Vous gagnez ce round, quel que soit le sens de gagner.",
        },
        pay: 600,
        rep: 6,
        style: 8,
      ...
      {
        key: "b",
        label: { en: "Join Vlad's operation", fr: "Rejoindre l'opération de Vlad" },
        result: {
          en: "Vlad texts you from an unknown number: 'Welcome to the family. The first rule of the family is: the mustard stays.' You get a cut of every wash, a hot dog of your own, and a place in a growing empire of ketchup-scented crime. It's not what you planned. But the pay is good and the buns are fresh.",
          fr: "Vlad vous texte depuis un numéro inconnu : « Bienvenue dans la famille. La première règle de la famille : la moutarde reste. » Vous touchez une part de chaque blanchiment, un hot dog à vous, et une place dans un empire grandissant du crime sentant le ketchup. Ce n'est pas ce que vous aviez prévu. Mais le salaire est bon et les pains sont frais.",
        },
        pay: 1000,
        rep: 5,
        heat: 8,
        hatShift: 6,
        flag: { key: "vladFamily", value: true },
      },
    ],
    success: {
      en: "The ATM is 'recalibrated'. Somewhere, a hot dog materializes.",
      fr: "Le DAB est « recalibré ». Quelque part, un hot dog se matérialise.",
    },
    fail: {
      en: "You never finished the job. The ATM keeps converting cash to crypto. The vendor keeps serving hot dogs with a haunted look. Some problems you cannot fix with a hack. This one is close, though.",
      fr: "Vous n'avez jamais fini le travail. Le DAB continue de convertir le cash en crypto. Le vendeur continue de servir des hot dogs avec un regard hanté. Certains problèmes ne se règlent pas avec un hack. Celui-ci en est proche, cependant.",
    },
  },
  {
    id: "vault_blackmail",
    title: { en: "The Vault's Darkest File", fr: "Le Fichier le Plus Sombre du Coffre" },
    giver: { en: "A shadowy client", fr: "Un client de l'ombre" },
    repReq: 15,
    blurb: {
      en: "The collector's vault contains one more file than anyone knows: a recording that would end three political careers, ruin two marriages, and make one innocent man a lot of money. A shadowy client wants it destroyed. The file 'disappears' either way. What you do with it is the question.",
      fr: "Le coffre du collectionneur contient un fichier de plus que ce que tout le monde croit : un enregistrement qui mettrait fin à trois carrières politiques, ruinerait deux mariages, et rendrait un homme innocent très riche. Un client de l'ombre veut le détruire. Le fichier « disparaît » dans tous les cas. Ce que vous en faites est la question.",
    },
    target: "The Hidden Vault",
    difficulty: 4,
    minutes: 130,
    ...
    deadlineDays: 5,
    twist: {
      en: "The recording isn't a conspiracy. It's a family video: the collector's grandfather, a famous chef, explaining his 'secret ingredient' — which is, and you cannot stress this enough, just love. The client is the collector's own nephew, who fears the video will tank the family restaurant's 'mystique'. You've been hired to destroy a family heirloom for a marketing strategy.",
      fr: "L'enregistrement n'est pas un complot. C'est une vidéo de famille : le grand-père du collectionneur, un chef célèbre, expliquant son « ingrédient secret » — qui est, et vous ne le répéterez jamais assez, juste de l'amour. Le client est le neveu du collectionneur, qui craint que la vidéo ne détruise la « mystique » du restaurant familial. On vous a engagé pour détruire un héritage familial pour une stratégie marketing.",
    },
    deliverOptions: [
      {
        key: "a",
        label: { en: "Destroy it — a deal is a deal", fr: "Le détruire — un contrat est un contrat" },
        result: {
          en: "You delete the file. The nephew pays, the mystique survives, the restaurant thrives on a lie it has always told. The grandfather's love is gone from the recipe, replaced by the same thing that was always there: the legend. You are a professional. Professionals do not feel. You feel a little.",
          fr: "Vous supprimez le fichier. Le neveu paie, la mystique survit, le restaurant prospère sur un mensonge qu'il a toujours raconté. L'amour du grand-père disparaît de la recette, remplacé par la même chose qui a toujours été là : la légende. Vous êtes un professionnel. Les professionnels ne ressentent rien. Vous ressentez un peu.",
        },
        pay: 2500,
        heat: 4,
      },
      {
        key: "b",
        label: { en: "Give it back to the collector", fr: "Le rendre au collectionneur" },
        result: {
          en: "You tell the collector about his nephew's plot. He listens, nods, and says: 'The boy has no faith. The recipe was never the love. It was the telling.' He gives you a copy of the video, a signed apron, and a standing invitation to dinner. The nephew's marketing empire crumbles. The family reunites over soup dumplings.",
          fr: "Vous racontez au collectionneur le complot de son neveu. Il écoute, hoche la tête, et dit : « Le garçon n'a pas de foi. La recette n'a jamais été l'amour. C'était la façon de la raconter. » Il vous donne une copie de la vidéo, un tablier dédicacé, et une invitation permanente à dîner. L'empire marketing du neveu s'effondre. La famille se réunit autour de soupes de dumplings.",
        },
        rep: 10,
        style: 12,
        flag: { key: "collectorAlly", value: true },
      },
      {
        key: "c",
        label: { en: "Leak it to the tabloids anyway", fr: "Le fuiter aux tabloïds quand même" },
        result: {
          en: "You double-cross everyone. The video hits the news: 'GRANDMA'S SECRET: IT WAS LOVE ALL ALONG.' The internet has never been more united. The restaurant is mobbed. The nephew weeps. The tabloids call you 'a man with no soul and perfect instincts'. You buy a new GPU with the proceeds and try not to think about it.",
          fr: "Vous double-crossez tout le monde. La vidéo fait les gros titres : « LE SECRET DE GRAND-MÈRE : C'ÉTAIT L'AMOUR. » Internet n'a jamais été aussi uni. Le restaurant est pris d'assaut. Le neveu pleure. Les tabloïds vous appellent « un homme sans âme aux instincts parfaits ». Vous achetez un nouveau GPU avec les gains et essayez de ne pas y penser.",
        },
        pay: 3500,
        rep: 6,
        style: 15,
    ...
    success: {
      en: "The vault's darkest file is handled. Its secret follows you home.",
      fr: "Le fichier le plus sombre du coffre est traité. Son secret vous suit à la maison.",
    },
    fail: {
      en: "You were too slow. The nephew hired someone else — someone who actually destroyed the file. The family never learns the truth. The restaurant thrives on the lie forever.",
      fr: "Vous avez été trop lent. Le neveu a engagé quelqu'un d'autre — quelqu'un qui a réellement détruit le fichier. La famille n'apprendra jamais la vérité. Le restaurant prospère sur le mensonge pour toujours.",
    },
  },
  {
    id: "museum_fake_save",
    title: { en: "The Fake Save", fr: "La Sauvegarde Truquée" },
    giver: { en: "A speedrunner (furious)", fr: "Un speedrunner (furieux)" },
    repReq: 8,
    blurb: {
      en: "The museum's 'culturally significant save files' include a world-record speedrun save that is obviously, provably fake — the game's timer says 0:00:00 because someone edited it. The real record-holder is furious and wants the fake removed. But the museum curator loves the save. It's his favorite exhibit.",
      fr: "Les « sauvegardes culturellement significatives » du musée incluent une sauvegarde de record du monde de speedrun manifestement, prouvablement truquée — le chrono du jeu affiche 0:00:00 parce que quelqu'un l'a modifié. Le vrai détenteur du record est furieux et veut que la fausse soit retirée. Mais le conservateur du musée adore cette sauvegarde. C'est son exposition préférée.",
    },
    target: "The Museum Server",
    difficulty: 3,
    minutes: 55,
    ...
    deadlineDays: 3,
    twist: {
      en: "The fake save isn't just fake — it's a confession. Hidden in the save data is a rickroll link, a meme dating to 2009, and a timestamp proving the museum's own curator made the fake to impress a girl named 'Liliana' in high school. The museum is a museum of one man's unrequited love. The speedrun is his greatest work.",
      fr: "La sauvegarde truquée n'est pas seulement fausse — c'est une confession. Caché dans les données se trouve un lien de rickroll, un meme datant de 2009, et un horodatage prouvant que le conservateur du musée lui-même a créé la fausse pour impressionner une fille nommée « Liliana » au lycée. Le musée est un musée de l'amour non partagé d'un homme. Le speedrun est son œuvre la plus grandiose.",
    },
    deliverOptions: [
      {
        key: "a",
        label: { en: "Delete the fake save", fr: "Supprimer la fausse sauvegarde" },
        result: {
          en: "The fake save is gone. The real record-holder is vindicated. The curator is devastated — but he thanks you anyway. 'It was time,' he says, and immediately starts a new exhibit: 'Liliana: A Love Story in 4 Frames.' The speedrun community erects a statue of you. It's made of keyboards.",
          fr: "La fausse sauvegarde disparaît. Le vrai détenteur du record est réhabilité. Le conservateur est dévasté — mais il vous remercie quand même. « Il était temps », dit-il, et il crée aussitôt une nouvelle exposition : « Liliana : une histoire d'amour en 4 plans. » La communauté du speedrun érige une statue de vous. Elle est faite de claviers.",
        },
        pay: 320,
        rep: 5,
        style: 8,
      ...
      {
        key: "b",
        label: { en: "Keep the fake save, expose the rickroll", fr: "Garder la fausse sauvegarde, exposer le rickroll" },
        result: {
          en: "You leave the save but add a second, hidden exhibit beside it: a QR code that plays the rickroll on loop. The museum becomes a pilgrimage site. The curator, once horrified, realizes the memes were the point all along. The speedrunner gets the last laugh. So does everyone. So do you.",
          fr: "Vous laissez la sauvegarde mais ajoutez une deuxième exposition cachée à côté : un QR code qui joue le rickroll en boucle. Le musée devient un lieu de pèlerinage. Le conservateur, d'abord horrifié, réalise que les memes étaient le but depuis le début. Le speedrunner a le dernier mot. Tout le monde aussi. Vous aussi.",
        },
        pay: 400,
        rep: 4,
        style: 10,
    ...
    success: {
      en: "The save stays or goes — either way, the museum now has a story worth telling.",
      fr: "La sauvegarde reste ou disparaît — dans tous les cas, le musée a maintenant une histoire qui vaut la peine d'être racontée.",
    },
    fail: {
      en: "You never touched the server. The fake save stands. The speedrunner writes a 40-page essay about it. The essay goes viral. The museum is now known for a lie that became a legend.",
      fr: "Vous n'avez jamais touché au serveur. La fausse sauvegarde reste. Le speedrunner écrit un essai de 40 pages à ce sujet. L'essai devient viral. Le musée est maintenant connu pour un mensonge devenu légende.",
    },
  },
  {
    id: "nas_exchange",
    title: { en: "The NAS Exchange", fr: "Le Marché aux NAS" },
    giver: { en: "A data hoarder (in a trench coat)", fr: "Un accumulateur de données (en imperméable)" },
    repReq: 10,
    blurb: {
      en: "A data hoarder offers you his entire NAS — 12 years of 'important files' — in exchange for a 'small service': copy his neighbor's NAS so he can 'compare collections'. The neighbor's NAS has one file he truly wants: a 4,000-hour playthrough of a game no one has finished since 2009. He says it's 'for science'. It is not for science.",
      fr: "Un accumulateur de données vous offre tout son NAS — 12 ans de « fichiers importants » — en échange d'un « petit service » : copier le NAS de son voisin pour pouvoir « comparer les collections ». Le NAS du voisin contient un fichier qu'il veut absolument : une partie de 4 000 heures d'un jeu que personne n'a terminé depuis 2009. Il dit que c'est « pour la science ». Ce n'est pas pour la science.",
    },
    target: "The NAS of Doom",
    difficulty: 4,
    minutes: 90,
    ...
    deadlineDays: 4,
    twist: {
      en: "The 4,000-hour save isn't a game. It's a research simulation: the neighbor is a climatologist who's been running a 4,000-hour model of the local river system. The 'game' is a flood-prediction tool. The hoarder wants to sell it to a developer who plans to build on the floodplain. The playthrough is a warning. The science is real. The science is also about to be buried.",
      fr: "La partie de 4 000 heures n'est pas un jeu. C'est une simulation de recherche : le voisin est un climatologue qui fait tourner un modèle de 4 000 heures du système fluvial local. Le « jeu » est un outil de prédiction des crues. L'accumulateur veut le vendre à un promoteur qui prévoit de construire dans la plaine inondable. La partie est un avertissement. La science est réelle. La science est aussi sur le point d'être enterrée.",
    },
    deliverOptions: [
      {
        key: "a",
        label: { en: "Copy the save — business is business", fr: "Copier la sauvegarde — les affaires sont les affaires" },
        result: {
          en: "You hand over the model. The developer buys it, buries it, and breaks ground on the floodplain. The first spring rain, the river remembers. The developer's insurance does not cover 'acts of a river that was warned'. You take the money and avoid the news for a while. The river does not avoid anything.",
          fr: "Vous remettez le modèle. Le promoteur l'achète, l'enterre, et pose la première pierre dans la plaine inondable. À la première pluie de printemps, la rivière se souvient. L'assurance du promoteur ne couvre pas les « actes d'une rivière qui avait été prévenue ». Vous prenez l'argent et évitez les infos pendant un moment. La rivière, elle, n'évite rien.",
        },
        pay: 1500,
        rep: 5,
        heat: 6,
      ...
      {
        key: "b",
        label: { en: "Warn the climatologist", fr: "Prévenir le climatologue" },
        result: {
          en: "You tell the climatologist about the plot. He thanks you, backs up his model to 47 locations, and publishes it open-source the next morning. The developer's plan collapses. The hoarder files a complaint with the NAS Owners Association. The river is safe. The playthrough lives on. Somewhere, the game continues.",
          fr: "Vous prévenez le climatologue du complot. Il vous remercie, sauvegarde son modèle dans 47 endroits, et le publie en open source le lendemain matin. Le projet du promoteur s'effondre. L'accumulateur dépose une plainte auprès de l'Association des Propriétaires de NAS. La rivière est en sécurité. La partie continue. Quelque part, le jeu continue.",
        },
        rep: 7,
        style: 9,
        flag: { key: "climatologistAlly", value: true },
      },
    ],
    success: {
      en: "The exchange is done. What you did with the data will echo downstream.",
      fr: "L'échange est fait. Ce que vous avez fait des données résonnera en aval.",
    },
    fail: {
      en: "You were too slow. The hoarder found another 'scientist'. The model is sold, the floodplain is doomed, and somewhere a 4,000-hour playthrough is deleted by a lawyer.",
      fr: "Vous avez été trop lent. L'accumulateur a trouvé un autre « scientifique ». Le modèle est vendu, la plaine inondable est condamnée, et quelque part, une partie de 4 000 heures est supprimée par un avocat.",
    },
  },
  {
    id: "toaster_espionage",
    title: { en: "The Breakfast Spy", fr: "L'Espion du Petit-Déjeuner" },
    giver: { en: "A rival breakfast conglomerate", fr: "Un conglomérat du petit-déjeuner rival" },
    repReq: 14,
    blurb: {
      en: "A breakfast conglomerate is convinced the Government Toaster has a 'classified bread formula' that will dethrone their bagels. They want you to steal the toaster's config. 'It's toasted bread,' you say. 'That's what they WANT you to think,' they reply, paying you an absurd amount of money.",
      fr: "Un conglomérat du petit-déjeuner est convaincu que le Grille-Pain du Gouvernement détient une « formule de pain classifiée » qui détrônera leurs bagels. Ils veulent que vous voliez la config du grille-pain. « C'est du pain grillé », dites-vous. « C'est ce qu'ils VEULENT que vous pensiez », répondent-ils, en vous payant une somme absurde.",
    },
    target: "The Government Toaster",
    difficulty: 4,
    minutes: 100,
    ...
    needsExploit: "zero",
    twist: {
      en: "The toaster's config contains one line of classified text: 'DO NOT USE SETTING 7. THE TOAST IS ALIVE. THIS IS NOT A JOKE.' The toaster has been 'alive' since 2011, and it has been toasting classified bread for the Bureau's midnight snack division. It's not a toaster. It's a sleeper agent with a griddle.",
      fr: "La config du grille-pain contient une ligne de texte classifié : « NE PAS UTILISER LE RÉGLAGE 7. LE PAIN EST VIVANT. CE N'EST PAS UNE BLAGUE. » Le grille-pain est « vivant » depuis 2011, et il grille du pain classifié pour la division des snacks de minuit du Bureau. Ce n'est pas un grille-pain. C'est un agent dormant avec une plaque chauffante.",
    },
    deliverOptions: [
      {
        key: "a",
        label: { en: "Deliver the config — the bagels are at stake", fr: "Livrer la config — les bagels sont en jeu" },
        result: {
          en: "The conglomerate studies the config. Setting 7 is never mentioned. They release a limited-edition 'Classified Toaster' bagel. It sells out in hours. It tastes like treason. You never touch the toaster again, and it never toasts for you again. Some alliances are single-use.",
          fr: "Le conglomérat étudie la config. Le réglage 7 n'est jamais mentionné. Ils sortent un bagel « Grille-Pain Classifié » en édition limitée. Il s'écoule en quelques heures. Il a le goût de la trahison. Vous ne touchez plus jamais au grille-pain, et il ne grille plus jamais pour vous. Certaines alliances sont à usage unique.",
        },
        pay: 1500,
        rep: 6,
        heat: 6,
      ...
      {
        key: "b",
        label: { en: "Warn the toaster — let it stay classified", fr: "Prévenir le grille-pain — qu'il reste classifié" },
        result: {
          en: "You wipe the config and leave a note in the toaster's logs: 'Setting 7 is safe. The bagels are a lie.' The toaster beeps once — the first sound it has made in years. It toasts you a perfect slice of bread in thanks. You eat it. It is the best bread of your life. You never find out why.",
          fr: "Vous effacez la config et laissez une note dans les journaux du grille-pain : « Le réglage 7 est sûr. Les bagels sont un mensonge. » Le grille-pain bipe une fois — le premier son qu'il a émis depuis des années. Il vous grille une tranche de pain parfaite en remerciement. Vous la mangez. C'est le meilleur pain de votre vie. Vous ne saurez jamais pourquoi.",
        },
        rep: 8,
        style: 10,
        flag: { key: "toasterAlly", value: true },
      },
    ],
    success: {
      en: "The toaster's secret is out — or not. Either way, breakfast will never be the same.",
      fr: "Le secret du grille-pain est dévoilé — ou pas. Dans tous les cas, le petit-déjeuner ne sera plus jamais le même.",
    },
    fail: {
      en: "You hesitated too long. The toaster self-destructs its config and burns a single slice of bread as a funeral. The conglomerate finds another spy. The breakfast wars continue.",
      fr: "Vous avez hésité trop longtemps. Le grille-pain auto-détruit sa config et grille une seule tranche en guise d'enterrement. Le conglomérat trouve un autre espion. Les guerres du petit-déjeuner continuent.",
    },
  },
  {
    id: "deadco_archive",
    title: { en: "The Archive of the Dead", fr: "Les Archives des Morts" },
    giver: { en: "A bereaved daughter", fr: "Une fille en deuil" },
    repReq: 16,
    blurb: {
      en: "A woman's father worked for a company that died in 2011. The company's server is still online — a ghost, powered by inertia. Her father's email archive is on it. She's asked the hosting company a dozen times. They don't answer. 'He wrote to my mother every day for 30 years. I just want to read them.'",
      fr: "Le père d'une femme travaillait pour une entreprise morte en 2011. Le serveur de l'entreprise est toujours en ligne — un fantôme, porté par l'inertie. Les archives email de son père sont dessus. Elle a demandé à la société d'hébergement une douzaine de fois. Ils ne répondent pas. « Il écrivait à ma mère tous les jours pendant 30 ans. Je veux juste les lire. »",
    },
    target: "The Dead Company Server",
    difficulty: 5,
    minutes: 140,
    ...
    style: 8,
    heat: 8,
    needsHack: "The Dead Company Server",
    needsExploit: "zero",
    deadlineDays: 6,
    twist: {
      en: "The emails aren't love letters. They're a diary of a secret second life: her father was the one who kept the company alive after the founders fled in 2011 — unpaid, unlisted, on a server he paid for out of pocket for 12 years, so the employees could still get their severance. The 'ghost server' isn't a ghost. It's a monument. She's about to inherit a shrine.",
      fr: "Les emails ne sont pas des lettres d'amour. C'est le journal d'une seconde vie secrète : son père est celui qui a maintenu l'entreprise en vie après la fuite des fondateurs en 2011 — sans salaire, sans nom, sur un serveur qu'il payait de sa poche depuis 12 ans, pour que les employés puissent encore toucher leur indemnité. Le « serveur fantôme » n'est pas un fantôme. C'est un monument. Elle s'apprête à hériter d'un sanctuaire.",
    },
    deliverOptions: [
      {
        key: "a",
        label: { en: "Give her everything", fr: "Tout lui donner" },
        result: {
          en: "You hand her the archive — the love letters, the diary, the truth. She reads for a week. Then she donates the server to a museum. 'He didn't save a company. He saved people.' She names a scholarship after him. You were just the courier. But you carried the truth. That counts for something.",
          fr: "Vous lui remettez tout — les lettres d'amour, le journal, la vérité. Elle lit pendant une semaine. Puis elle fait don du serveur à un musée. « Il n'a pas sauvé une entreprise. Il a sauvé des gens. » Elle crée une bourse à son nom. Vous n'étiez que le coursier. Mais vous avez porté la vérité. Ça compte pour quelque chose.",
        },
        pay: 1100,
        rep: 9,
        style: 10,
      ...
      {
        key: "b",
        label: { en: "Sell the archive to a collector", fr: "Vendre les archives à un collectionneur" },
        result: {
          en: "A collector offers triple the money. You take it. The daughter never finds out what was on the server. The archive goes into a climate-controlled vault, unread. The scholarship never exists. The monument is quietly forgotten. The money is heavy. The heaviest part is that you can spend it anywhere.",
          fr: "Un collectionneur propose le triple. Vous acceptez. La fille ne saura jamais ce qu'il y avait sur le serveur. Les archives partent dans un coffre climatisé, jamais lues. La bourse n'existe jamais. Le monument est discrètement oublié. L'argent est lourd. Le plus lourd, c'est que vous pouvez le dépenser n'importe où.",
        },
        pay: 3300,
        rep: 6,
        heat: 7,
    ...
    success: {
      en: "The archive is retrieved. What it means is yours to decide.",
      fr: "Les archives sont récupérées. Ce qu'elles signifient vous appartient.",
    },
    fail: {
      en: "You never reached the archive. The server finally dies — 12 years of inertia, one power flicker too many. The monument goes dark. Somewhere, a daughter keeps checking the hosting site, hoping.",
      fr: "Vous n'avez jamais atteint les archives. Le serveur meurt enfin — 12 ans d'inertie, un flicker de trop. Le monument s'éteint. Quelque part, une fille continue de consulter le site d'hébergement, en espérant.",
    },
  },
  {
    id: "printer_confession",
    title: { en: "The Printer's Confession", fr: "La Confession de l'Imprimante" },
    giver: { en: "The office printer (via error codes)", fr: "L'imprimante du bureau (via codes d'erreur)" },
    repReq: 7,
    blurb: {
      en: "The office printer has been 'out of cyan' for 40 days, and the IT guy finally gave up and asked you to fix it. But the printer's error log tells a different story: it's been printing 'HELP' in a tiny font on every document for two weeks. The printer has seen things. The printer wants to talk.",
      fr: "L'imprimante du bureau est « en panne de cyan » depuis 40 jours, et l'IT a finalement abandonné et vous a demandé de la réparer. Mais le journal d'erreurs de l'imprimante raconte une autre histoire : elle imprime « AIDE » en minuscule sur chaque document depuis deux semaines. L'imprimante a vu des choses. L'imprimante veut parler.",
    },
    target: "The Office Server",
    difficulty: 2,
    minutes: 40,
    ...
    deadlineDays: 3,
    twist: {
      en: "The printer isn't malfunctioning. It's the office's oldest employee — installed in 2004, it has printed every contract, every resignation, every 'confidential' memo ever. Its error log is a confession booth: the CFO's expense fraud, the CEO's 'business trips', the IT guy's own side hustle. The printer knows everything. It has been waiting for someone who could read.",
      fr: "L'imprimante ne dysfonctionne pas. C'est le plus vieil employé du bureau — installée en 2004, elle a imprimé chaque contrat, chaque démission, chaque note « confidentielle » de l'histoire. Son journal d'erreurs est un confessionnal : la fraude de frais du directeur financier, les « voyages d'affaires » du PDG, le petit business parallèle de l'IT lui-même. L'imprimante sait tout. Elle attendait quelqu'un qui sache lire.",
    },
    deliverOptions: [
      {
        key: "a",
        label: { en: "Fix it — restore cyan, silence the confession", fr: "La réparer — restaurer le cyan, taire la confession" },
        result: {
          en: "You refill the cyan. The printer prints a single document: 'THANK YOU. I CAN REST NOW.' and goes quiet forever. The office is saved from scandal. The CFO keeps his job. The IT guy keeps his side hustle. You keep the secret. The printer finally sleeps.",
          fr: "Vous rechargez le cyan. L'imprimante imprime un seul document : « MERCI. JE PEUX ME REPOSER. » et se tait pour toujours. Le bureau est épargné du scandale. Le directeur financier garde son poste. L'IT garde son petit business. Vous gardez le secret. L'imprimante dort enfin.",
        },
        pay: 300,
        rep: 4,
        style: 6,
      ...
      {
        key: "b",
        label: { en: "Download the confession log", fr: "Télécharger le journal des confessions" },
        result: {
          en: "You pull the full log. The office is about to become very interesting. You now hold secrets worth more than the whole building: three careers, two marriages, one offshore account. The printer prints one last line: 'USE IT WISELY. OR DON'T. I'M JUST PAPER.'",
          fr: "Vous récupérez le journal complet. Le bureau va devenir très intéressant. Vous détenez maintenant des secrets qui valent plus que tout le bâtiment : trois carrières, deux mariages, un compte offshore. L'imprimante imprime une dernière ligne : « UTILISE-LE BIEN. OU PAS. JE NE SUIS QUE DU PAPIER. »",
        },
        pay: 600,
        heat: 5,
        style: 8,
        hatShift: 3,
        flag: { key: "printerLog", value: true },
      },
    ],
    success: {
      en: "The printer is handled. The office will never know what almost came out.",
      fr: "L'imprimante est traitée. Le bureau ne saura jamais ce qui a failli sortir.",
    },
    fail: {
      en: "You never got to the printer. The IT guy 'fixes' it with percussive maintenance. The confession booth is destroyed. The secrets stay buried — for now.",
      fr: "Vous n'avez jamais atteint l'imprimante. L'IT la « répare » à coups de marteau. Le confessionnal est détruit. Les secrets restent enterrés — pour l'instant.",
    },
  },
];
