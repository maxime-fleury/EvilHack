...
const CAT: Record<string, Bilingual> = {
  ...
  "hack.noroFix": { en: "Noro-chan: ohh~ '{bad}'? You clearly meant '{good}', dummy~ I fixed it for you 💜", fr: "Noro-chan : ohh~ « {bad} » ? Tu voulais clairement dire « {good} », boulet~ J'ai corrigé pour toi 💜" },
  ...
  "heat.raidChoices": { en: "The man in the suit is here. He's polite. He's patient. And he gives you options — all of them fine:", fr: "L'homme en costume est là. Il est poli. Il est patient. Et il te donne des options — toutes correctes :" },
  "heat.knockLog": { en: "A man in a suit knocked on the door. Heat is peaking.", fr: "Un homme en costume a frappé à la porte. La chaleur est au max." },
  "heat.flee": { en: "You grabbed Frank, slipped out the back, and 'went for a walk'. Heat cools off. No one lost anything.", fr: "Vous avez attrapé Frank, filé par-derrière, et « fait une promenade ». La chaleur retombe. Personne n'a rien perdu." },
  "heat.fleeFlavor": { en: "A pigeon on the fire escape watched you leave. It nodded. It understands.", fr: "Un pigeon sur l'échelle de secours vous a regardé partir. Il a hoché la tête. Il comprend." },
  "heat.fleeLog": { en: "Fled the heat out the back window.", fr: "A fui la chaleur par la fenêtre de derrière." },
  "heat.brave": { en: "You opened the door and stared him down. 'Evening, officer. Can I help you?' He blinked first. Legend status: +{r} rep.", fr: "Vous avez ouvert la porte et l'avez fixé. « Bonsoir, monsieur l'agent. Je peux vous aider ? » Il a cligné des yeux en premier. Statut de légende : +{r} réputation." },
  "heat.braveNews": { en: "Local Man Out-Stares Officer Over 'Suspicious Activity'", fr: "Un homme local fixe un agent jusqu'à ce qu'il cille pour « activité suspecte »" },
  "heat.braveNewsB": { en: "Witnesses say the officer simply turned around and left. The man's laptop beeped approvingly.", fr: "Des témoins affirment que l'agent a simplement fait demi-tour. L'ordinateur portable de l'homme a bipé d'approbation." },
  "heat.braveLog": { en: "Stared down the man in the suit. Absolute legend.", fr: "A fixé l'homme en costume. Légende absolue." },
  "raid.none": { en: "Nobody's knocking. The street is quiet — suspiciously quiet.", fr: "Personne ne frappe. La rue est calme — étrangement calme." },
  "raid.how": { en: "The man in the suit is waiting. Pick how to handle it:", fr: "L'homme en costume attend. Choisis comment gérer ça :" },
  "combo.up": { en: "🔥 Streak ×{n} — loot ×{m}", fr: "🔥 Combo ×{n} — butin ×{m}" },
  "combo.legend": { en: "Legendary streak! Loot ×{m} — nothing can stop you now.", fr: "Combo légendaire ! Butin ×{m} — plus rien ne t'arrête." },
  ...
  // mira — the romance arc
  "mira.title": { en: "MIRA — 3B", fr: "MIRA — 3B" },
  "mira.unknown": { en: "Mira? Never heard of her. (Deliver your first mission and raise your rep a bit — she'll find you.)", fr: "Mira ? Connais pas. (Livrez votre première mission et montez un peu la réputation — elle vous trouvera.)" },
  "mira.status": { en: "Relationship: {s}", fr: "Relation : {s}" },
  "mira.relationship": { en: "dating (she said the noodles were 'acceptable')", fr: "en couple (elle a dit que les nouilles étaient « acceptables »)" },
  "mira.epFlirt": { en: "dating — she held your hand over the spicy noodles", fr: "en couple — elle a tenu ta main au-dessus des nouilles épicées" },
  "mira.epShy": { en: "dating — she found your shyness 'endearing, in a terminal-error kind of way'", fr: "en couple — elle trouve ta timidité « attendrissante, façon erreur de terminal »" },
  "mira.epBro": { en: "dating — it started as a joke and neither of you is laughing now", fr: "en couple — c'était parti pour rigoler, et plus personne ne rigole" },
  "mira.epilogue": { en: "Her router blinks a pattern at 3AM: 'u up? coffee machine is fixed. bring the good snacks.' You smile at Frank. Frank says nothing. Frank approves.", fr: "Son routeur clignote un message à 3h du mat : « t'es réveillé ? machine à café réparée. amène les bons snacks. » Tu souris à Frank. Frank ne dit rien. Frank approuve." },
  "mira.perkReminder": { en: "Perk active: 'Mira's Node' — −8% heat, +5% loot.", fr: "Perk actif : « Nœud de Mira » — −8% de chaleur, +5% de butin." },
  "mira.alreadyReply": { en: "You already replied. Don't double-text. Noro-chan is judging the double-text.", fr: "Tu as déjà répondu. Pas de double message. Noro-chan juge le double message." },
  "mira.replied": { en: "You reply: 'snacks guy. i'm a devops guy. hacks? a little. you?'", fr: "Tu réponds : « le gars des snacks. moi c'est devops. des hacks ? un peu. et toi ? »" },
  "mira.replyFlavor": { en: "Her reply is instant: 'devops?? so you break things professionally AND recreationally. cool. coffee machine at my old office is a mess. i have a plan.'", fr: "Sa réponse est instantanée : « devops ?? donc tu casses des trucs en professionnel ET en amateur. cool. la machine à café de mon ancien bureau est une épave. j'ai un plan. »" },
  "mira.noroJealous": { en: "Noro-chan: 'ohh~ look at YOU. texting. like a real boy. i'm fine. i'm totally fine.'", fr: "Noro-chan : « ohh~ regardez-moi ça. TEXTO. comme un vrai garçon. moi ça va. je vais très bien. »" },
  "mira.alreadyGift": { en: "You already gifted her. Gifts are like exploits: one at a time, timed well.", fr: "Tu lui as déjà offert un cadeau. Les cadeaux, c'est comme les exploits : un à la fois, bien chronométrés." },
  "mira.noMoney": { en: "You need {m} for a gift. Frank's wallet is weeping.", fr: "Il te faut {m} pour un cadeau. Le portefeuille de Frank pleure." },
  "mira.gifted": { en: "You spend {m} on a gift — a vintage mechanical keyboard, because of course.", fr: "Tu dépenses {m} pour un cadeau — un clavier mécanique vintage, évidemment." },
  "mira.giftFlavor": { en: "She opens the box. Silence. Then: 'the clicky kind. oh no.' Her cursor hovers over your name for a full minute before she types: 'you're dangerous. i like it.'", fr: "Elle ouvre la boîte. Silence. Puis : « la version cliquante. oh non. » Son curseur reste sur ton nom une minute entière avant qu'elle tape : « t'es dangereux. j'aime ça. »" },
  "mira.badChoice": { en: "'mira date <flirt|shy|bro>' — pick a lane, snack boy.", fr: "« mira date <flirt|shy|bro> » — choisis une voie, gars des snacks." },
  "mira.alreadyDate": { en: "You already said the thing. The thing was said. It echoed. It was good.", fr: "Tu as déjà dit le truc. Le truc a été dit. Il a résonné. C'était bien." },
  "mira.date.flirt": { en: "You say it: 'the coffee machine was never the problem. i'd fix yours.' She types 'ha' then deletes it. Then types: 'my router is blinking. that's me. blushing. this is so embarrassing. date?'", fr: "Tu dis le truc : « la machine à café n'a jamais été le problème. je réparerais la tienne. » Elle tape « ha » puis efface. Puis elle tape : « mon routeur clignote. c'est moi. je rougis. c'est tellement gênant. un rencard ? »" },
  "mira.date.shy": { en: "You mumble something about coffee. She hears you anyway. 'cute. you're the quiet kind of dangerous. okay. noodles, tomorrow, 8pm. don't be late or i'll hack your router.'", fr: "Tu marmonnes un truc sur le café. Elle t'entend quand même. « mignon. t'es dangereux en mode discret. ok. nouilles, demain, 20h. sois pas en retard ou je pirate ton routeur. »" },
  "mira.date.bro": { en: "You play it cool: 'sure, we can hang. no big deal.' She types: 'no big deal. sure. i'm totally not rearranging my entire router setup for this. see you at 8.'", fr: "Tu joues la coolitude : « ouais, on peut se voir. sans pression. » Elle tape : « sans pression. bien sûr. je ne réarrange pas tout mon setup réseau pour l'occasion. à 20h. »" },
  "mira.dateFlavor": { en: "The noodles place. Two blocks away. Smells like a war crime. She's already there, wearing a MegaCorp hoodie she definitely stole. 'You're late. Kidding. You're perfect. Sit down.'", fr: "Le resto de nouilles. À deux rues. Ça sent le crime de guerre. Elle est déjà là, dans un hoodie MegaCorp qu'elle a forcément volé. « T'es en retard. Je rigole. T'es parfait. Assieds-toi. »" },
  "mira.noroWatching": { en: "Noro-chan: 'i'll be here. watching the routers. this is my life now.'", fr: "Noro-chan : « moi je serai là. à surveiller les routeurs. c'est ma vie maintenant. »" },
  "mira.doneReply": { en: "✔ You replied.", fr: "✔ Tu as répondu." },
  "mira.todoReply": { en: "▸ Reply to her — mira reply", fr: "▸ Réponds-lui — mira reply" },
  "mira.doneCoffee": { en: "✔ The office coffee machine is hers.", fr: "✔ La machine à café du bureau est à elle." },
  "mira.todoCoffee": { en: "▸ Hack The Office Coffee Machine — for her", fr: "▸ Pirate The Office Coffee Machine — pour elle" },
  "mira.doneGift": { en: "✔ The keyboard was a hit.", fr: "✔ Le clavier a fait mouche." },
  "mira.todoGift": { en: "▸ Bring her a gift — mira gift ($150)", fr: "▸ Offre-lui un cadeau — mira gift (150 $)" },
  "mira.doneDate": { en: "✔ You said the thing.", fr: "✔ Tu as dit le truc." },
  "mira.todoDate": { en: "▸ Say the thing — mira date <flirt|shy|bro>", fr: "▸ Dis le truc — mira date <flirt|shy|bro>" },
  "mira.relStrangers": { en: "strangers (she found your router, though)", fr: "inconnus (elle a quand même trouvé ton routeur)" },
  "mira.relFriends": { en: "friends (she says 'friend' in a voice that means more)", fr: "amis (elle dit « ami » d'une voix qui veut dire plus)" },
  "mira.relDating": { en: "dating — the routers blink in sync", fr: "en couple — les routeurs clignotent à l'unisson" },
...
export const CMD_DETAIL: Record<string, Bilingual> = {
  ...
  settings: { en: "Keys: theme, fontsize, anim, sound, chips (on|off — easy mode), lang (en|fr), ainame, aiurl, aiprompt. `settings ai` shows the AI sidekick's editable persona prompt.", fr: "Clés : theme, fontsize, anim, sound, chips (on|off — mode facile), lang (en|fr), ainame, aiurl, aiprompt. `settings ai` affiche le prompt modifiable de votre IA." },
  ...
  mira: { en: "Mira was fired the same Friday as you and hacks two floors up. Reply, help her with the office coffee machine, bring a gift, and — eventually — say the thing. Optional. Tender. Slightly illegal.", fr: "Mira a été virée le même vendredi que vous et pirate deux étages au-dessus. Répondez, aidez-la avec la machine à café du bureau, offrez un cadeau, et — un jour — dites le truc. Facultatif. Tendre. Légèrement illégal." },
};
