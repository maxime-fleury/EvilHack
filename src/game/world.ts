...
export const FUN_HOSTS: Omit<TargetDef, "id">[] = [
  ...
  { name: "The Museum Server", difficulty: 3, basePayout: 260, heat: 6, flavor: { en: "A dusty museum server preserving 'culturally significant' save files. The curator has no idea what 'sav' files are. He thinks they're documents.", fr: "Un serveur poussiéreux de musée préservant des sauvegardes « culturellement significatives ». Le conservateur ignore ce que sont les fichiers « sav ». Il croit que ce sont des documents." }, loot: "cash", skill: "sql" },
  { name: "The Linux User Group Server", difficulty: 4, basePayout: 420, heat: 9, flavor: { en: "A server running a 2009 distro because 'it works'. The admin is 72. The uptime is 4,000 days. Touching it is a sin. Hacking it is a worse sin. The LUG will forgive you. Eventually.", fr: "Un serveur sous une distro de 2009 parce que « ça marche ». L'admin a 72 ans. L'uptime est de 4 000 jours. Y toucher est un péché. Le pirater, un péché pire. Le LUG vous pardonnera. Un jour." }, loot: "cash", skill: "zero" },
  { name: "The NAS of Doom", difficulty: 4, basePayout: 480, heat: 9, flavor: { en: "A network-attached storage unit with 12 years of 'important files'. Half are game saves. The other half are cats. The cats are organized. The saves are chaos.", fr: "Un NAS avec 12 ans de « fichiers importants ». La moitié sont des sauvegardes de jeux. L'autre moitié, des chats. Les chats sont organisés. Les sauvegardes, c'est le chaos." }, loot: "info", skill: "sql" },
  { name: "The Hackerman C2", difficulty: 5, basePayout: 700, heat: 12, flavor: { en: "A command-and-control server whose operators still type 'hackerman' as the password. The firewall rules are written in Comic Sans. You are not safe here. You are also not impressed.", fr: "Un serveur de commande et contrôle dont les opérateurs utilisent encore « hackerman » comme mot de passe. Les règles du pare-feu sont en Comic Sans. Vous n'êtes pas en sécurité ici. Vous n'êtes pas impressionné non plus." }, loot: "info", skill: "zero" },
  { name: "The Dead Company Server", difficulty: 5, basePayout: 820, heat: 13, flavor: { en: "A server of a company that died in 2011. It still runs, powered by inertia and a promise. The admin's auto-reply is still active: 'Out of office. Forever.'", fr: "Le serveur d'une entreprise morte en 2011. Il tourne encore, porté par l'inertie et une promesse. La réponse automatique de l'admin est toujours active : « Absent. Pour toujours. »" }, loot: "info", skill: "zero" },
];
...
export interface NewsFiller {
  headline: Bilingual;
  body: Bilingual;
  /** category for Noro-chan's commentary: hack | crypto | cats | weeb | fbi | mega | money | misc */
  tag?: string;
}
...
export const NEWS_FILLERS: NewsFiller[] = [
  ...
  { headline: { en: "Study: 1 in 3 IT admins has a body pillow", fr: "Étude : 1 admin IT sur 3 a un body pillow" }, body: { en: "The remaining 2 in 3 are lying. The pillow industry is thriving.", fr: "Les 2 sur 3 restants mentent. L'industrie du body pillow se porte très bien." }, tag: "weeb" },
  { headline: { en: "Darknet forum reaches 40k members, all named 'anon'", fr: "Un forum du darknet atteint 40 000 membres, tous nommés « anon »" }, body: { en: "'We're not a cult, we're a community,' says anon #39,978.", fr: "« On n'est pas une secte, on est une communauté », déclare anon n°39 978." }, tag: "hack" },
  { headline: { en: "Man hacks own fridge, fridge demands 'more cheese'", fr: "Un homme pirate son propre frigo, le frigo exige « plus de fromage »" }, body: { en: "The fridge has since unionized. It now sends passive-aggressive notifications.", fr: "Le frigo s'est depuis syndiqué. Il envoie maintenant des notifications passives-agressives." }, tag: "hack" },
  { headline: { en: "New ransomware demands victims print memes", fr: "Un nouveau rançongiciel exige que les victimes impriment des memes" }, body: { en: "The only company that paid is now an office decorated in 'doge', 2013 style.", fr: "La seule entreprise qui a payé est maintenant un bureau décoré « doge », style 2013." }, tag: "hack" },
  { headline: { en: "Cat accidentally DDOSes neighbor's router by sitting on it", fr: "Un chat fait un DDoS involontaire sur le routeur du voisin en s'asseyant dessus" }, body: { en: "The cat remains unrepentant. It has since been promoted to 'network admin'.", fr: "Le chat reste impénitent. Il a depuis été promu « admin réseau »." }, tag: "cats" },
  { headline: { en: "PUPPYCOIN 'stablecoin' rug pull leaves investors holding literal dog treats", fr: "Le « stablecoin » PUPPYCOIN se retire, laissant les investisseurs avec de vraies friandises pour chien" }, body: { en: "Experts call it 'the most delicious rug pull in history'.", fr: "Les experts parlent de « la rug pull la plus délicieuse de l'histoire »." }, tag: "crypto" },
  { headline: { en: "Local 'crypto bro' still waiting on Lambo since 2017", fr: "Un « frère crypto » attend toujours sa Lambo depuis 2017" }, body: { en: "His spreadsheet remains 'imminent'. His therapist disagrees.", fr: "Son tableur reste « imminent ». Son thérapeute n'est pas d'accord." }, tag: "crypto" },
  { headline: { en: "Anime convention accidentally hires real hackers as 'cosplay security'", fr: "Une convention anime engage par erreur de vrais hackers comme « sécurité cosplay »" }, body: { en: "Breaches are down 400%. No one knows how. Everyone is scared of the girl in the maid outfit.", fr: "Les intrusions ont baissé de 400 %. Personne ne sait comment. Tout le monde a peur de la fille en tenue de maid." }, tag: "weeb" },
  { headline: { en: "'Body pillow' stock rises 300% after survey", fr: "Les actions « body pillow » montent de 300 % après un sondage" }, body: { en: "The survey was, in fact, answered entirely by body pillows.", fr: "Le sondage a, en réalité, été rempli entièrement par des body pillows." }, tag: "weeb" },
  { headline: { en: "FBI agent caught speedrunning raid during 'surveillance'", fr: "Un agent du FBI surpris en train de speedrunner un raid pendant sa « surveillance »" }, body: { en: "The suspect got away. The loot did not. Priorities.", fr: "Le suspect s'est échappé. Le butin, non. Question de priorités." }, tag: "fbi" },
  { headline: { en: "MegaCorp layoffs 'synergy-optimized', employees confused", fr: "Les licenciements chez MegaCorp « optimisés par synergie », les employés perplexes" }, body: { en: "One fired engineer reportedly 'took the snacks with him'. MegaCorp has since hired 3 snack auditors.", fr: "Un ingénieur viré aurait « emporté les snacks avec lui ». MegaCorp a depuis embauché 3 auditeurs de snacks." }, tag: "mega" },
  { headline: { en: "Vet clinic's 'cat photobank' valued at $2M", fr: "La « photothèque de chats » d'un vétérinaire est évaluée à 2 M$" }, body: { en: "The cats remain unaware of their market value. They are too busy being cats.", fr: "Les chats ignorent leur valeur marchande. Ils sont trop occupés à être des chats." }, tag: "cats" },
  { headline: { en: "Local landlord accused of 'yelling at boiler' for 12th year running", fr: "Une propriétaire accusée de « crier sur sa chaudière » pour la 12e année consécutive" }, body: { en: "The boiler has not broken since 2012. The strategy is 'controversial but effective'.", fr: "La chaudière n'a pas cassé depuis 2012. La stratégie est « controversée mais efficace »." }, tag: "mega" },
  { headline: { en: "Darknet fashion week: hackers debut 'suspicious hoodie' collection", fr: "Semaine de la mode du darknet : les hackers dévoilent leur collection « hoodie suspect »" }, body: { en: "Critics praise the 'authentic silhouette'. Everyone in the audience is wearing one.", fr: "Les critiques saluent la « silhouette authentique ». Tout le public en porte une." }, tag: "hack" },
  { headline: { en: "Money printer goes brrr, economy does… something", fr: "La planche à billets fait brrr, l'économie fait… quelque chose" }, body: { en: "Economists have no idea. Neither does the printer.", fr: "Les économistes n'en savent rien. La planche à billets non plus." }, tag: "money" },
  { headline: { en: "Ransomware gang apologizes: 'we targeted a bakery, sorry'", fr: "Un gang de ransomware s'excuse : « on a ciblé une boulangerie, désolé »" }, body: { en: "The apology was written in Comic Sans. The bakery forgave them, mostly for the font.", fr: "Les excuses sont écrites en Comic Sans. La boulangerie leur a pardonné, surtout pour la police." }, tag: "hack" },
];
