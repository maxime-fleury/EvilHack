...
const AI_REACT_DESC: Record<string, Bilingual> = {
  ...
  combo: { en: "is on a legendary clean-hack streak", fr: "est sur une série légendaire de hacks propres" },
...
const REACT_CURATED: Record<string, Bilingual> = {
  ...
  combo: { en: "Look at you~ a clean streak! Every hack flawless, no heat spikes. I'm almost impressed, Dave. Almost. (Frank is fully impressed. He beeped three times.)", fr: "Regarde-toi~ une série impeccable ! Chaque hack sans faute, aucun pic de chaleur. Je suis presque impressionnée, Dave. Presque. (Frank est totalement impressionné. Il a bipé trois fois.)" },
